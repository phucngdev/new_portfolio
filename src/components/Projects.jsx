          ...
          >
            <div className="min-w-full md:min-w-[50%]">
              <div className="transition-transform duration-300 ease-in-out">
                <div className="w-full bg-[#1e1e1e] p-4 md:p-8 rounded-s-2xl">
                  ...
                  <div className="max-h-[200px] overflow-y-auto md:max-h-none">
                    <ul className="list-disc text-[#b0b0b0] text-sm md:text-[16px]">
                      ...
                      <li className="marker:text-primary">
                        Designed and developed REST APIs using Node.js, and
                        implemented database schemas in PostgreSQL
                      </li>
                      <li className="marker:text-primary">
                        Built and integrated real-time features using WebSocket
                        for live data updates and notifications
                      </li>
                      <li className="marker:text-primary">
                        Handled the full deployment pipeline from development to
                        publishing on both Google Play and App Store platforms
                      </li>
                    </ul>
                  </div>
            ...
            <div className="min-w-full md:min-w-[50%]">
              <div className="transition-transform duration-300 ease-in-out">
                <div className="w-full bg-[#1e1e1e] p-4 md:p-8 rounded-e-2xl">
                  <div className="text-[24px] mb-2 font-bold text-primary">
                    TEELAB STORE
                  </div>
                  <div className="my-2">
            ...
            <div className="min-w-full md:min-w-[50%] md:ms-20">
              <div className="transition-transform duration-300 ease-in-out">
                <div className="w-full bg-[#1e1e1e] p-4 md:p-8 rounded-s-2xl">
                  <div className="text-[24px] mb-2 font-bold text-primary">
                    TEELAB STORE
